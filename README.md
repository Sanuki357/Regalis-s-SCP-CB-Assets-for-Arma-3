...
```bash
tools/make force checkexternal release 0.4.1
```
...
Modify the numbers in here to represent your build version. The example listed above would be: `0.4.1.18`. This version will be set in each pbo during binarizing. It will also be used in the signature file names, along the commit hash. This will make it easier to identify the exact version that is being used.
