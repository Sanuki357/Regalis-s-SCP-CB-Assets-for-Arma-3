...
def main():
    ...
    print("""
  ######################################
  # SCP_CB Development Environment Setup #
  ######################################
  This script will create your SCP_CB dev environment for you.
  Before you run this, you should already have:
    - A properly setup ACE3 Development Environment
  If you have not done those things yet, please abort this script in the next step and do so first.
  This script will create two hard links on your system, both pointing to your SCP_CB project folder:
    [Arma 3 installation directory]\\{} => SCP_CB project folder
    P:\\{}                              => SCP_CB project folder
